//package oldstudy.globalresolution;
//
//import java.util.*;
//
//public class Test {
...
//        // reference.
//        Collections.sort(orderBook, (a, b,c) -> Order.compareByQuantity(a, b,b));
//        Collections.sort(orderBook, Order::compareByQuantity);
//
//        Collections.sort(orderBook, new Comparator<Order>() {
//            @Override
//            public int compare(Order o1, Order o2) {
//                return Order.compareByQuantity(o1,o2,o2);
//            }
//        }Order::compareByQuantity);
//
...
//    }
//
//    public static int compareByQuantity(Order a, Order b,Order c){
