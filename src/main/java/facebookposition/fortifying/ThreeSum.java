...
public class ThreeSum {
    ...
    /**
     ...
     Psudocode
     Usng window sliding of fixed frame 3 will add and reduce 3 frame elemts
     meantime will calculate its sum and if zero that list will be added to the output list
     */
